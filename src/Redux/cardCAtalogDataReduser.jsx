...
let CardCAtalogDataReduser = (state = initialState, action) => {
    switch(action.type){
        ...
        case setUsers:
            return{
                ...state,
                cardCAtalogData: [...state.cardCAtalogData, ...action.cardCAtalogData]
            }
        default:
            return state
...
export const setUsersAC = (cardCAtalogData) =>{
    return{
        type: setUsers,
        cardCAtalogData
    }
...
export default CardCAtalogDataReduser